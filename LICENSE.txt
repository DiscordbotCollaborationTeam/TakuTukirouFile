LICENSE is CC BY-SA 2.0.

ライセンスは、CC BY-SA2.0です。
...
t-takuscratch[at]outlook[dot]jp
...
日本語訳:
表示 - 継承 2.0 一般 (CC BY-SA 2.0) コモンズ証

これは人が読んでわかりやすいようにしたライセンスの要約です。(ライセンスの代わりになるものではありません。) あなたは以下の条件に従う限り、自由に：
...
引用:Japanese Scratch-Wiki https://ja.scratch-wiki.info/wiki/Japanese_Scratch-Wiki:クリエイティブ・コモンズ_表示-継承_2.0 より
